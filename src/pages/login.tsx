...
const Login = () => {
  ...
  const [isAuthModalOpen, setAuthModalOpen] = useState(false); // State for Auth Modal
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center pt-16">
      {/* Hide Header & Footer when Auth Modal is Open */}
      {!isAuthModalOpen && (
        <>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              <div className="mt-1">
                <input
                  ...
                  className="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 transition-colors duration-200"
            ...
            <div>
              <button
                type="submit"
                disabled={isLoading}
                className="w-full flex justify-center items-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors duration-200"
              >
                {isLoading ? (
